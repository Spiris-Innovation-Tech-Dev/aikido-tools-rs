...
use crate::tools::{
    api::{AikidoApiDeleteInput, AikidoApiGetInput, AikidoApiPostInput, AikidoApiPutInput},
    ...
    issues::{
        ...
        AikidoIssueGroupGetInput, AikidoIssueGroupIgnoreInput,
        AikidoIssueGroupNotesAddInput, AikidoIssueGroupSnoozeInput,
        AikidoIssueGroupTasksInput, AikidoIssueGroupUnignoreInput,
        AikidoIssueGroupUnsnoozeInput, AikidoIssueGroupsListInput,
        AikidoIssueIgnoreInput, AikidoIssueSnoozeInput,
        AikidoIssueUnignoreInput, AikidoIssueUnsnoozeInput,
    },
    reports::{
...
impl AikidoMcpServer {
    ...
    #[tool(description = "Get workspace information including name, linked provider, and organization.")]
    pub async fn aikido_workspace_info(
        &self,
        #[tool(aggr)] _input: AikidoWorkspaceInfoInput,
    ) -> Result<CallToolResult, ErrorData> {
        let info = self.state.client.get_workspace_info().await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_issues_list(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupsListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let groups: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&groups).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }

    #[tool(description = "Get detailed information about a specific issue group including all individual issues with affected files, packages, repos, and remediation guidance.")]
    pub async fn aikido_issues_group_get(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupGetInput,
    ) -> Result<CallToolResult, ErrorData> {
    ...
    pub async fn aikido_issues_get(
        &self,
        #[tool(aggr)] input: AikidoIssueGetInput,
    ) -> Result<CallToolResult, ErrorData> {
        let issue = self.state.client.get_issue(input.issue_id).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_issues_counts(
        &self,
        #[tool(aggr)] _input: AikidoIssueCountsInput,
    ) -> Result<CallToolResult, ErrorData> {
        let counts = self.state.client.get_issue_counts().await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_issues_export(
        &self,
        #[tool(aggr)] _input: AikidoIssueExportInput,
    ) -> Result<CallToolResult, ErrorData> {
        let data = self.state.client.export_issues().await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_issues_snooze(
        &self,
        #[tool(aggr)] input: AikidoIssueSnoozeInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = SnoozeRequest {
            snooze_until: input.snooze_until,
            reason: input.reason,
        };
        self.state.client.snooze_issue(input.issue_id, &body).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue snoozed")]))
    }

    #[tool(description = "Unsnooze a previously snoozed issue.")]
    pub async fn aikido_issues_unsnooze(
        &self,
        #[tool(aggr)] input: AikidoIssueUnsnoozeInput,
    ) -> Result<CallToolResult, ErrorData> {
        self.state.client.unsnooze_issue(input.issue_id).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue unsnoozed")]))
    }

    #[tool(description = "Ignore an issue with an optional reason.")]
    pub async fn aikido_issues_ignore(
        &self,
        #[tool(aggr)] input: AikidoIssueIgnoreInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = IgnoreRequest { reason: input.reason };
        self.state.client.ignore_issue(input.issue_id, &body).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue ignored")]))
    }

    #[tool(description = "Unignore a previously ignored issue.")]
    pub async fn aikido_issues_unignore(
        &self,
        #[tool(aggr)] input: AikidoIssueUnignoreInput,
    ) -> Result<CallToolResult, ErrorData> {
        self.state.client.unignore_issue(input.issue_id).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue unignored")]))
    }

    #[tool(description = "Snooze an issue group until a specified date.")]
    pub async fn aikido_issues_group_snooze(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupSnoozeInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = SnoozeRequest {
            snooze_until: input.snooze_until,
            reason: input.reason,
        };
        self.state.client.snooze_issue_group(input.group_id, &body).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue group snoozed")]))
    }

    #[tool(description = "Unsnooze a previously snoozed issue group.")]
    pub async fn aikido_issues_group_unsnooze(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupUnsnoozeInput,
    ) -> Result<CallToolResult, ErrorData> {
        self.state.client.unsnooze_issue_group(input.group_id).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue group unsnoozed")]))
    }

    #[tool(description = "Ignore an issue group with an optional reason.")]
    pub async fn aikido_issues_group_ignore(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupIgnoreInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = IgnoreRequest { reason: input.reason };
        self.state.client.ignore_issue_group(input.group_id, &body).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue group ignored")]))
    }

    #[tool(description = "Unignore a previously ignored issue group.")]
    pub async fn aikido_issues_group_unignore(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupUnignoreInput,
    ) -> Result<CallToolResult, ErrorData> {
        self.state.client.unignore_issue_group(input.group_id).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Issue group unignored")]))
    }

    #[tool(description = "Add a note/comment to an issue group.")]
    pub async fn aikido_issues_group_notes_add(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupNotesAddInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = NoteRequest { comment: input.comment };
        self.state.client.add_note_to_issue_group(input.group_id, &body).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_issues_group_tasks(
        &self,
        #[tool(aggr)] input: AikidoIssueGroupTasksInput,
    ) -> Result<CallToolResult, ErrorData> {
        let tasks = self.state.client.get_issue_group_tasks(input.group_id).await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&tasks).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }

    #[tool(description = "List all code repositories with name, provider, branch, and scan status.")]
    pub async fn aikido_repos_list(
        &self,
        #[tool(aggr)] input: AikidoReposListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let repos: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_repos_get(
        &self,
        #[tool(aggr)] input: AikidoRepoGetInput,
    ) -> Result<CallToolResult, ErrorData> {
        let repo = self.state.client.get_code_repo(input.repo_id).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_repos_scan(
        &self,
        #[tool(aggr)] input: AikidoRepoScanInput,
    ) -> Result<CallToolResult, ErrorData> {
        self.state.client.scan_code_repo(input.repo_id).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Scan triggered")]))
    }

    #[tool(description = "List SAST (Static Application Security Testing) rules.")]
    pub async fn aikido_repos_sast_rules(
        &self,
        #[tool(aggr)] _input: AikidoSastRulesListInput,
    ) -> Result<CallToolResult, ErrorData> {
        let rules = self.state.client.list_sast_rules().await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_repos_iac_rules(
        &self,
        #[tool(aggr)] _input: AikidoIacRulesListInput,
    ) -> Result<CallToolResult, ErrorData> {
        let rules = self.state.client.list_iac_rules().await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&rules).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }
    ...
    pub async fn aikido_repos_custom_rules(
        &self,
        #[tool(aggr)] _input: AikidoCustomRulesListInput,
    ) -> Result<CallToolResult, ErrorData> {
        let rules = self.state.client.list_custom_rules().await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&rules).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }
    ...
    pub async fn aikido_containers_list(
        &self,
        #[tool(aggr)] input: AikidoContainersListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let containers: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_containers_get(
        &self,
        #[tool(aggr)] input: AikidoContainerGetInput,
    ) -> Result<CallToolResult, ErrorData> {
        let container = self.state.client.get_container(input.container_id).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_containers_scan(
        &self,
        #[tool(aggr)] input: AikidoContainerScanInput,
    ) -> Result<CallToolResult, ErrorData> {
        self.state.client.scan_container(input.container_id).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Scan triggered")]))
    }
    ...
    pub async fn aikido_clouds_list(
        &self,
        #[tool(aggr)] input: AikidoCloudsListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let clouds: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_domains_list(
        &self,
        #[tool(aggr)] input: AikidoDomainsListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let domains: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_domains_scan(
        &self,
        #[tool(aggr)] input: AikidoDomainScanInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = StartDomainScanRequest { domain_id: input.domain_id };
        self.state.client.start_domain_scan(&body).await.map_err(aikido_error_to_mcp)?;
        Ok(CallToolResult::success(vec![Content::text("Domain scan started")]))
    }

    #[tool(description = "List all teams with their responsibilities.")]
    pub async fn aikido_teams_list(
        &self,
        #[tool(aggr)] input: AikidoTeamsListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let teams: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_teams_create(
        &self,
        #[tool(aggr)] input: AikidoTeamCreateInput,
    ) -> Result<CallToolResult, ErrorData> {
        let body = CreateTeamRequest { name: input.name };
        let result = self.state.client.create_team(&body).await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&result).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }
    ...
    pub async fn aikido_users_list(
        &self,
        #[tool(aggr)] input: AikidoUsersListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let users: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_users_get(
        &self,
        #[tool(aggr)] input: AikidoUserGetInput,
    ) -> Result<CallToolResult, ErrorData> {
        let user = self.state.client.get_user(input.user_id).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_firewall_apps_list(
        &self,
        #[tool(aggr)] input: AikidoFirewallAppsListInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let apps: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_firewall_app_get(
        &self,
        #[tool(aggr)] input: AikidoFirewallAppGetInput,
    ) -> Result<CallToolResult, ErrorData> {
        let app = self.state.client.get_firewall_app(input.app_id).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_compliance_iso(
        &self,
        #[tool(aggr)] _input: AikidoComplianceIsoInput,
    ) -> Result<CallToolResult, ErrorData> {
        let overview = self.state.client.get_iso_compliance_overview().await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_compliance_soc2(
        &self,
        #[tool(aggr)] _input: AikidoComplianceSoc2Input,
    ) -> Result<CallToolResult, ErrorData> {
        let overview = self.state.client.get_soc2_compliance_overview().await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&overview).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }
    ...
    pub async fn aikido_compliance_nis2(
        &self,
        #[tool(aggr)] _input: AikidoComplianceNis2Input,
    ) -> Result<CallToolResult, ErrorData> {
        let overview = self.state.client.get_nis2_compliance_overview().await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&overview).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }
    ...
    pub async fn aikido_activity_log(
        &self,
        #[tool(aggr)] input: AikidoActivityLogInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let log: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
    ...
    pub async fn aikido_ci_scans(
        &self,
        #[tool(aggr)] input: AikidoCiScansInput,
    ) -> Result<CallToolResult, ErrorData> {
        ...
        let scans: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&scans).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }

    #[tool(description = "Raw API GET passthrough for full endpoint coverage.")]
    pub async fn aikido_api_get(
        &self,
        #[tool(aggr)] input: AikidoApiGetInput,
    ) -> Result<CallToolResult, ErrorData> {
        let endpoint = normalize_endpoint(&input.endpoint);
        let data: Value = self.state.client.get(&endpoint).await.map_err(aikido_error_to_mcp)?;
        let json = serde_json::to_string_pretty(&data).unwrap_or_default();
        Ok(CallToolResult::success(vec![Content::text(json)]))
    }

    #[tool(description = "Raw API POST passthrough for full endpoint coverage.")]
    pub async fn aikido_api_post(
        &self,
        #[tool(aggr)] input: AikidoApiPostInput,
    ) -> Result<CallToolResult, ErrorData> {
        let endpoint = normalize_endpoint(&input.endpoint);
        let body = input.body.unwrap_or_else(|| Value::Object(serde_json::Map::new()));
        let data: Value = self
            .state
            .client
            .post(&endpoint, &body)
    ...
    #[tool(description = "Raw API PUT passthrough for full endpoint coverage.")]
    pub async fn aikido_api_put(
        &self,
        #[tool(aggr)] input: AikidoApiPutInput,
    ) -> Result<CallToolResult, ErrorData> {
        let endpoint = normalize_endpoint(&input.endpoint);
        let body = input.body.unwrap_or_else(|| Value::Object(serde_json::Map::new()));
        let data: Value = self
    ...
    #[tool(description = "Raw API DELETE passthrough for full endpoint coverage.")]
    pub async fn aikido_api_delete(
        &self,
        #[tool(aggr)] input: AikidoApiDeleteInput,
    ) -> Result<CallToolResult, ErrorData> {
        let endpoint = normalize_endpoint(&input.endpoint);
        self.state
            .client
